...
module.exports = {
  siteMetadata: {
    title: `Blog by Vikram`,
    name: `Vikram's Blog`,
    description:
      "This is a presonal blog to follow the progress of my side/main projects with anectodes!",
    siteUrl: `https://vikramp.me`,
    siteSlogan: `Welcome to my blog!`,
    siteLinks: [
      {
        name: "sitemap",
